        ...
        <>
            ...
            >
                <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <Button onClick={showToast} className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20">
                            ...
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <motion.div key={course.id} variants={itemVariants}>
                                        <Card className="glassmorphic-card h-full flex flex-col">
                                            <CardHeader className="flex-row items-start gap-4">
                                                <div className="p-3 bg-secondary/50 rounded-lg">{course.icon}</div>
                                                <div>
                             ...
                             {filteredCourses.length === 0 && (
                                <div className="text-center py-16">
                                    <p className="text-muted-foreground">No courses found. Try a different filter or search term.</p>
                                </div>
                            )}
                        </TabsContent>
                    </Tabs>
