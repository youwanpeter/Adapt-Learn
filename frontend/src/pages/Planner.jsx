...
const initialTasks = [
    { id: 1, text: "Finish Chapter 5 quiz for History of AI", completed: false, dueDate: "Tomorrow" },
    { id: 2, text: "Outline essay on Ethics in Machine Learning", completed: false, dueDate: "In 3 days" },
    { id: 3, text: "Read research paper on Quantum Computing", completed: true, dueDate: "Yesterday" },
    { id: 4, text: "Prepare presentation slides for project proposal", completed: false, dueDate: "In 5 days" },
];
...
const Planner = () => {
    ...
    const showToast = (message = "This feature isn't implemented yet—but don't worry! You can request it in your next prompt! 🚀") => {
        toast({
    ...
    const handleAddTask = (e) => {
        ...
        if (newTaskText) {
            setTasks([...tasks, { id: tasks.length + 1, text: newTaskText, completed: false, dueDate: "Soon" }]);
            e.target.reset();
        }
            ...
            >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">Organize your study schedule and stay on top of your tasks.</p>
                  </div>
                   <Dialog>
                        ...
                        <DialogContent>
                            <form onSubmit={handleAddTask}>
                                ...
                                <div className="grid gap-4 py-4">
                                    <Input id="task" name="task" placeholder="e.g. Read chapter 7 of Neuroscience" />
                                </div>
                                <DialogFooter>
                                    <DialogClose asChild>
                         ...
                         <Card className="glassmorphic-card">
                             ...
                             <CardContent className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch id="google-calendar" onCheckedChange={() => showToast()} />
                                </div>
                                 <div className="flex items-center justify-between">
                                    <Label htmlFor="outlook-calendar">Microsoft Outlook</Label>
                                    <Switch id="outlook-calendar" onCheckedChange={() => showToast()} />
                                </div>
                             </CardContent>
                        </Card>
                    </motion.div>
